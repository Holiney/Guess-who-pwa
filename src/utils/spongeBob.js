...
export const spongebobCharacters = [
  { id: 1, name: "Очкарик", img: barnacle_boy },
  { id: 2, name: "Бабб Бас", img: bubble_bass },
  { id: 3, name: "Коп", img: cop },
  { id: 4, name: "Огірок Кевін", img: cumber_kevin },
  { id: 5, name: "Брудна булька", img: dirty_bubble },
  { id: 6, name: "Фред", img: fred },
  { id: 7, name: "Гері", img: gary },
  { id: 8, name: "Гарольд", img: harold_squarepants },
  { id: 9, name: "Карен", img: karen },
  { id: 10, name: "Мс. Крабс", img: krabs },
  { id: 11, name: "Ларі Лобстер", img: larry_lobster },
  { id: 12, name: "Мен Рэй", img: man_ray },
  { id: 13, name: "Margaret", img: margaret },
  { id: 14, name: "Супермен", img: mermaid_man },
  { id: 15, name: "Міс Паф", img: mrs_puff },
  { id: 16, name: "Нептун", img: neptune },
  { id: 17, name: "Ст. Дженкінс", img: old_djenkins },
  { id: 18, name: "Патрік", img: patrick },
  { id: 19, name: "Перл", img: pearl_krabs },
  { id: 20, name: "Планктон", img: pllankton },
  { id: 21, name: "Сенді", img: sandy },
  { id: 22, name: "Губка Боб", img: sponge_bob },
  { id: 23, name: "Сквідвард", img: squidward },
  { id: 24, name: "Душитель", img: tattletale_strangler },
  { id: 25, name: "Тритон", img: triton },
];
